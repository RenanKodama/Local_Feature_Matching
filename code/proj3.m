...
% YOUR WORK IN HERE!
  %[x1, y1, x2, y2, matches, confidences] = compute_correspondences(image1g, image2g, scale_factor);
  
  [x1, y1] = get_interest_points(image1g, descriptor_window_image_width, 1);
  [x2, y2] = get_interest_points(image2g, descriptor_window_image_width, 1);
  
  [image1_features] = get_features(image1g, x1, y1, descriptor_window_image_width);
  [image2_features] = get_features(image2g, x2, y2, descriptor_window_image_width);
