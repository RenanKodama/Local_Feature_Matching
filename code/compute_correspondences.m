function [x1, y1, x2, y2, matches, confidences] = compute_correspondences( image1, image2, scale_factor)
...
[x1, y1] = get_interest_points(image1, descriptor_window_image_width, scale_factor);
[x2, y2] = get_interest_points(image2, descriptor_window_image_width, scale_factor);
